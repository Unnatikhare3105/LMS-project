...
export default function AuthPage() {
  ...
  //     return;
  //   }
  //   // Mock login for UI demo – navigate directly
  ...
  //             </div>
  //             <div className="flex justify-end">
  //               {/* <button className="text-xs text-violet-600 dark:text-violet-400 hover:underline">Forgot password?</button> */}
  //               <button
  //                 onClick={() => { setOtpEmail(form.email); setAuthStep('forgot'); }}
  //                 className="text-xs text-violet-600 dark:text-violet-400 hover:underline"
  //               >
  ...
  //               or{' '}
  //               {/* <button
  //                 onClick={() => toast.success('OTP sent to your email!')}
  //                 className="text-violet-600 dark:text-violet-400 hover:underline"
  //               >
  //                 sign in with OTP
  //               </button> */}
  ...
  //             </div>
  //             <div>
  //               <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-1.5">Mobile (+91)</label>
  //               <Input value={form.mobile} onChange={(v) => set('mobile', v)} placeholder="+91XXXXXXXXXX" />
  //             </div>
  //             <div>
  //               <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-1.5">Password</label>
  //               <Input value={form.password} onChange={(v) => set('password', v)} placeholder="Min 6 characters" type="password" />
  //             </div>
  //             <Button onClick={handleRegister} className="w-full mt-1" size="lg">
  //               Create account
  //             </Button>
  //           </div>
  //         )}
  ...
  //           <Input value={otpEmail} onChange={setOtpEmail} placeholder="you@example.com" type="email" />
  //         </div>
  //         {/* Show OTP input only after email submitted */}
  //         <div>
  //           <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-1.5">OTP</label>
  //           <Input value={otp} onChange={setOtp} placeholder="6-digit OTP" />
  //         </div>
  //         <Button onClick={handleVerifyOTP} loading={loading} className="w-full" size="lg">Verify OTP</Button>
  //         <Button onClick={handleSendOTP} loading={loading} className="w-full" size="lg" variant="ghost">Send / Resend OTP</Button>
  //         <button onClick={() => setAuthStep('login')} className="text-xs text-neutral-400 hover:underline w-full text-center">← Back to login</button>
  //       </div>
  //     )}
  ...
  //       <div className="space-y-3">
  //         <div>
  //           <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-1.5">Registered Email</label>
  //           <Input value={otpEmail} onChange={setOtpEmail} placeholder="you@example.com" type="email" />
  //         </div>
  //         <Button onClick={handleForgotSendOTP} loading={loading} className="w-full" size="lg">Send Reset OTP</Button>
  //         <button onClick={() => setAuthStep('login')} className="text-xs text-neutral-400 hover:underline w-full text-center">← Back to login</button>
  ...
  //       <div className="space-y-3">
  //         <div>
  //           <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-1.5">OTP sent to {otpEmail}</label>
  //           <Input value={otp} onChange={setOtp} placeholder="6-digit OTP" />
  //         </div>
  //         <Button onClick={handleVerifyForgotOTP} loading={loading} className="w-full" size="lg">Verify OTP</Button>
  //         <button onClick={() => setAuthStep('forgot')} className="text-xs text-neutral-400 hover:underline w-full text-center">← Back</button>
  //       </div>
  //     )}
