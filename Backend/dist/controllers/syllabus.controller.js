...
exports.deleteSyllabusController = exports.updateSyllabusController = exports.getSyllabusByIdController = exports.getAllTopicsController = exports.generateVideoController = exports.generateTextController = void 0;
...
const generateTextController = async (req, res, next) => {
    try {
        ...
        console.log('Generated syllabus:', syllabus); // Debug log to verify content
        res.status(200).json({
            success: true,
...
const getSyllabusByIdController = async (req, res, next) => {
    try {
        ...
        const syllabus = await syllabusService.getSyllabusByPublicId(syllabusId);
...
const updateSyllabusController = async (req, res, next) => {
    try {
        ...
        const updated = await syllabusService.updateSyllabusContent(syllabusId, content);
