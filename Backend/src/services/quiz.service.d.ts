...
export declare const submitQuiz: (publicId: string, score: number, timeTakenSeconds: number, userId: string) => Promise<IQuiz>;
...
export declare const getQuizByPublicId: (publicId: string, userId: string) => Promise<IQuiz>;
export declare const getLeaderboard: (limit?: number) => Promise<any[]>;
export declare const deleteQuiz: (publicId: string, userId: string) => Promise<void>;
